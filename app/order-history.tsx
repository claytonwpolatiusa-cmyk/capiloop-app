...
export default function OrderHistoryScreen() {
  ...
  return <ScreenContainer edges={["top", "bottom", "left", "right"]} className="flex-1"><FlatList
    ...
    contentContainerStyle={[styles.content, isCompact && styles.contentCompact, orderedReservations.length === 0 && styles.emptyContent]}
    ListHeaderComponent={<View style={[styles.header, isCompact && styles.headerCompact]}><CapiLoopBrand compact /><Pressable onPress={() => router.back()} style={({ pressed }) => [styles.back, isCompact && styles.backCompact, pressed && styles.pressed]} accessibilityLabel="Voltar"><MaterialIcons name="arrow-back" size={21} color="#151B14" /></Pressable><Text style={[styles.title, isCompact && styles.titleCompact]}>Histórico de pedidos</Text><Text style={styles.subtitle}>Veja pedidos anteriores e abra cada comprovante de retirada.</Text></View>}
