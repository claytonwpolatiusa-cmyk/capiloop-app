  ...
  return (
    <ScreenContainer edges={["top", "bottom", "left", "right"]} className="flex-1">
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.title}>{isReference ? "Vamos guardar esta sacola?" : "Quer mesmo reservar esta sacola?"}</Text>
        <Text style={styles.intro}>{isReference ? "Você verá o comprovante de retirada sem nenhuma cobrança." : "Revise a retirada e escolha como prefere concluir o pagamento."}</Text>
