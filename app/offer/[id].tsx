    ...
    <ScreenContainer edges={["top", "bottom", "left", "right"]} className="flex-1">
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.paymentHint}><MaterialIcons name="lock-outline" size={16} color="#5E7D00" /><Text style={styles.paymentHintText}>Pagamento seguro via Mercado Pago. Escolha PIX ou cartão no checkout.</Text></View>
        </View>
      </ScrollView>
