    ...
    <ScreenContainer edges={["top", "bottom", "left", "right"]} className="flex-1">
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.body}>
          <View style={styles.titleRow}><View style={styles.titleInfo}><Text style={[styles.store, isCompact && styles.storeCompact]} maxFontSizeMultiplier={1.25}>{offer.store}</Text><Text style={styles.bagType} maxFontSizeMultiplier={1.25}>{offer.subtitle}</Text></View><View style={styles.stock}><Text style={styles.stockText} maxFontSizeMultiplier={1.2}>{offer.stockLabel}</Text></View></View>
      ...
      <View style={styles.actionBar}>
        <View><Text style={styles.original} maxFontSizeMultiplier={1.2}>{formatCurrency(offer.originalPrice)}</Text><Text style={[styles.price, isCompact && styles.priceCompact]} maxFontSizeMultiplier={1.25}>{formatCurrency(offer.price)}</Text></View>
