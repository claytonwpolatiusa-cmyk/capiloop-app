...
export default function ProfileScreen() {
  ...
  const profileOptions = adminAccess.data?.allowed
    ? [...options, { icon: "admin-panel-settings", title: "Atendimento CapiLoop", detail: "Gerencie chamados da equipe" }]
    : options;
