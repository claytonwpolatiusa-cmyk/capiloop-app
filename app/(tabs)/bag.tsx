...
function EmptyBag() { return <MotionReveal style={styles.emptyState}><CapiLoopMascot variant="emptyBag" size={142} accessibilityLabel="Capivara CapiLoop convidando você a encontrar uma sacola" /><Text style={styles.emptyTitle}>Sua próxima sacola{"\n"}está por perto.</Text><Text style={styles.emptyCopy}>Reserve uma oferta e retire sabores incríveis por menos.</Text><TactilePressable onPress={() => router.replace("/(tabs)")} style={styles.primaryButton}><Text style={styles.primaryButtonText}>Ver sacolas de hoje</Text></TactilePressable></MotionReveal>; }
