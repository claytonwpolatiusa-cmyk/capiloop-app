...
export default function BagScreen() {
  ...
  return <ScreenContainer className="flex-1"><FlatList
    data={reservations} keyExtractor={(item) => item.id} contentContainerStyle={[styles.content, reservations.length === 0 && styles.emptyContent]}
    renderItem={({ item }) => {
    ...
    ListHeaderComponent={<View style={styles.header}><CapiLoopBrand compact /><Text style={styles.title}>Sua sacola</Text><Text style={styles.subtitle}>Reservas vinculadas à sua conta CapiLoop.</Text></View>}
